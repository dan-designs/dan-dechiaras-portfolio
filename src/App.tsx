      ...
      <div id="workflow-modal" tabIndex={-1} className="relative bg-[#0C0D00] border border-[#262626] rounded-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto shadow-2xl animate-in zoom-in-95 duration-300 focus:outline-none">
        ...
        <div className="p-6 space-y-8">
          <div>
            ...
            <p className="body-base text-[#d4d4d4] mb-4">
              Lately, my favorite experiments have been focused on the use of MCP connections to bring an agent-driven, end-to-end product flow to life. Through this exploration, not only have I successfully implemented a design-to-code and <a href="https://blog.bytebytego.com/p/figma-design-to-code-code-to-design?utm_campaign=post&utm_medium=web" target="_blank" rel="noopener noreferrer" className="text-accent hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent rounded-sm">code-to-design workflows</a> powered by Figma and Claude Code MCP connections, but I have also built an entire product team comprised of AI agents that work in parallel to me, leveraging connectors to Jira, Confluence, Miro, Dovetail, and Pendo. My approach to this solution has been template-focused, which means that at any point, I could help a coworker configure and spin up an instance for their own use.
            </p>
            <img 
        ...
        <div className="fixed bottom-[84px] md:bottom-8 right-6 md:right-8 z-50 animate-in slide-in-from-bottom-8 duration-500">
          ...
          >
            {project.id === 0 ? (
              ...
              <><FileText size={18} />Request Case Study</>
            )}
          </a>
        </div>
      </div>
